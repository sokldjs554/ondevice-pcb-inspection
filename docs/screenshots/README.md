...
장비 안 MCU에 판정을 넘기는 경로를 가정해 만든 바이너리 프레임입니다. SPI·I2C 장치가
없어서 루프백으로 왕복 일치, 1비트 손상, 잘린 프레임 검출까지 확인했습니다.
프레임 설계·직렬화·CRC·오류 처리는 검증했고 실제 버스 파형은 남은 과제입니다.
